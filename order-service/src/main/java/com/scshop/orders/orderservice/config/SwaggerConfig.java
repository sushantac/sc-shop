...
public class SwaggerConfig {
	...
	public Docket orderApis() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("order-apis").apiInfo(metaData()).select()
	...
	private ApiInfo metaData() {
		ApiInfo apiInfo = new ApiInfoBuilder().title("Order Service APIs")
				.description("Order Service APIs for managing orders")
