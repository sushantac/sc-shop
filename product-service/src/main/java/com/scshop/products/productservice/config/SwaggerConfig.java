...
public class SwaggerConfig {
	...
	public Docket orderApis() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("product-apis").apiInfo(metaData()).select()
	...
	private ApiInfo metaData() {
		ApiInfo apiInfo = new ApiInfoBuilder().title("Product Service APIs")
				.description("Product Service APIs for managing products")
